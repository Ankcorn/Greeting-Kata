...
const { greet, isShouting } = require('../index');
...
test('isShouting returns true if message was all caps', t => {
    const asd = isShouting("ANGRY SHOUTING");
    t.is(asd, true);
});

test('isShouting returns true if message was all caps', t => {
    const asd = isShouting("quiet ness");
    t.is(asd, false);
});
//# sourceMappingURL=/Users/tankcorn/Projects/Greeting Kata/node_modules/.cache/ava/6e0c8681ee11a0c389a03ff48c87fb59.js.map