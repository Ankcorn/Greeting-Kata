...
test('Oxford Comma Decides how to present last name', t => {
    const x = oxfordComma(2, 'test', 'test');
    t.is(x, "test and test");
});
test('Oxford Comma Decides how to present last name', t => {
    const x = oxfordComma(3, 'test', 'test');
    t.is(x, "test, and test");
});
test('NormalisemNames parses names separated by , into one array', t => {
    const names = normaliseNames(["Pirastero", "Helena, Thomas"]);
    t.is(names.toString(), ["Pirastero", "Helena", "Thomas"].toString());
});
//# sourceMappingURL=/Users/tankcorn/Projects/Greeting Kata/node_modules/.cache/ava/f17a92e031ec65ee4339a2cdd69f2507.js.map